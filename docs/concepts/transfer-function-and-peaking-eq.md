...
Formula convention: Robert Bristow-Johnson's [Audio EQ Cookbook](https://www.w3.org/TR/audio-eq-cookbook/). Runtime reference: [peaking EQ implementation](../../src/lib/dsp/biquad-eq.ts).
