...
These articles connect wave motion and feedback to filter response design and the coefficients used by a sample loop. Peaking EQ brings the general ideas together, and other filter prototypes extend the same design approach.
...
- [Discovering analog biquad filter prototypes](biquad-filter-prototypes.md) constructs low-pass and shelf responses from their desired properties and derives their digital coefficients.
