...
The editor is a focused tool for practicing and recording one live instrument or microphone against prepared backing audio. It covers the path from immediate playback of a practice take through comping and production export, without aiming for general DAW feature coverage.
