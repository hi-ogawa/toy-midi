...
export function ImportExport({
  ...
  const importMutation = useMutation({
    mutationFn: async () => {
      ...
      if (
        ...
        const { buffer, audioView } = await loadAudioFile(selectedFile);
  ...
  return (
    <>
      {/* Tab switcher */}
      <div className="flex border-b border-neutral-700 -mx-6 -mt-6 mb-6">
        <button
      ...
      {tab === "export" && (
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <label className="flex items-center gap-3 p-3 rounded border border-neutral-600 hover:border-neutral-500 cursor-pointer">
                ...
                />
                <div>
                  <div className="text-sm text-neutral-100">MIDI (.mid)</div>
                  <div className="text-xs text-neutral-400">
          ...
          <div className="text-sm text-neutral-400 bg-neutral-900 rounded p-3">
            ...
            <div>
              Tempo: {store.tempo} BPM &middot; {store.timeSignature.numerator}/
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2 text-sm">
                      <input
                        ...
                        className="accent-neutral-100"
                      />
                      <span className="text-neutral-200">Replace notes</span>
                    </label>
                    <label className="flex items-center gap-2 text-sm">
                      <input
                        type="radio"
                  ...
                  <div className="flex gap-4">
                    ...
                    <label className="flex items-center gap-2 text-sm">
                      <input
                        ...
                        className="accent-neutral-100"
                      />
                      <span className="text-neutral-200">Import time sig</span>
                    </label>
                  </div>
                </div>
              )}
      ...
      {/* Footer */}
      <div className="border-t border-neutral-700 -mx-6 -mb-6 mt-6 px-6 py-4 flex justify-end gap-3">
        {tab === "export" && (
          <>
            {exportFormat === "abc" && (
              <Button
