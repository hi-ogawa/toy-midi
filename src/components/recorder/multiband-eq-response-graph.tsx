...
export function MultibandEqResponseGraph({
  bands,
  selectedBandId,
  bypass,
  onSelectBand,
  ...
  return (
    <div
      data-testid="multiband-eq-response-graph"
      ...
      <div ref={plotRef} className="relative min-h-0 min-w-0 touch-none">
        ...
        >
          ...
          {bandResponses.map(({ band, path }, index) => (
            <path
              key={band.id}
              data-testid="multiband-eq-band-curve"
              d={path}
              fill="none"
          ...
          <path
            data-testid="multiband-eq-combined-curve"
            d={combinedPath}
            fill="none"
        ...
        {bands.map((band, index) => {
          ...
          return (
            <button
              key={band.id}
              type="button"
              data-testid="multiband-eq-response-point"
